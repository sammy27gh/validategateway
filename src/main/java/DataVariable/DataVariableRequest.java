...
public class DataVariableRequest {
	...
	public static String createRequestBody(DataVariable datavariable){
		...
		String request = "{\"getWebsite_id\": {\"client_name\": \""+datavariable.getWebsite_id()
        		+"\", \"Page_number\": \""+datavariable.getPage_number()
        		+"\", \"Keywords\" : \""+datavariable.getKeywords()
        		+"\" , \"Manufacturer_name\": [{\"issued_id_type\": \""+datavariable.getManufacturer_name()
        		+"\", \"Authorization\": \""+datavariable.getAuthorization()
        	    +"\"} ] }";
	...
	public static Headers createRequestHeader(DataVariable datavariable) throws Throwable{
		...
		//Header gtwCmpnyIdHdr = new Header("gateway-company-id", datavariable.getAuthorization());
		//Header gtwUsrIdHdr = new Header("gateway-user-id", datavariable.getGateway_user_id());
		//Header sessionIdHdr = new Header("session-id", datavariable.getSessionId());
        Header authorizationKeyHdr = new Header("Authorization", /*"Bearer  "+ bearerToken*/"");
	...
	public static Headers createRequestParametersBase(DataVariable datavariable){
		...
		//Header reqIdHdr = new Header("website-id", java.util.UUID.randomUUID().toString());
		...
		//Header authorizationKeyHdr = new Header("Authorization", "Bearer "+ datavariable);
